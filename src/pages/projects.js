...
const FeaturedProject = ({ type, title, summary, img, link, sourceLink, button, source }) => {
    ...
    return (
        <motion.article className='w-full flex justify-between items-center glassmorphism shadow-2xl p-12 relative lg:flex-col lg:p-8 xs:ronded-2xl xs:p-4 xs:w-[90%] m-0' {...fadeAnimation}>
                    ...
                    <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-8'>
                        ...
                        <div className='col-span-12'>
                            <FeaturedProject
                                ...
                                button="Visit"
                                source={false} />
                            <div className='w-full glassmorphism px-12 py-4 lg:px-8 xs:px-4 xs:ronded-2xl xs:w-[90%] m-0' {...slideAnimation("up", 0.5)} >
                                <motion.h2 className='mb-4 text-2xl font-bold uppercase text-primary heading tracking-widest' {...slideAnimation("left", 0.9)}>Key Features</motion.h2>
                                <motion.p className='font-medium' {...slideAnimation("left", 1)}> <b>Real-Time AR Visualization:</b> The AR Measuring Tape will leverage the power of Unity AR Foundation to provide a seamless AR experience. Users will be able to view the physical world through their device's camera while virtual measuring lines and points are superimposed onto objects in real-time.</motion.p>
                                <motion.p className='font-medium mt-4' {...slideAnimation("left", 1)}> <b>Distance Measurement:</b> The primary functionality of the app will be to measure distances between two points in the real world. By tapping on the screen, users can place anchor points on objects they wish to measure, and the app will display the distance between these points. </motion.p>
                                <motion.p className='font-medium my-4' {...slideAnimation("left", 1.04)}> <b>Basic Ray Tracing:</b> To ensure accurate measurements, the app will utilize basic ray tracing techniques. When a user places an anchor point on an object, a virtual ray will be cast from the camera's position towards the object, and the app will calculate the distance based on the intersection point of the ray and the object's surface. </motion.p>
                                <motion.p className='font-medium my-4' {...slideAnimation("left", 1.04)}> <b>Unit Conversion:</b> The app will support various units of measurement, such as centimeters, inches, feet, and meters. Users can easily switch between units according to their preferences or project requirements. </motion.p>
                                <motion.p className='font-medium my-4' {...slideAnimation("left", 1.08)}> <b>Visual Feedback and Guidance:</b> The application will provide visual feedback to assist users in accurately placing anchor points. For instance, the app might display a subtle grid or color-coded indicators to highlight the points of interest on the object. </motion.p>
                                <motion.p className='font-medium my-4' {...slideAnimation("left", 1.08)}> <b>Save and Share Measurements:</b> Users will have the option to save their measurements for future reference or share them with others. This feature will enhance the utility of the app for both personal and professional use. </motion.p>
                                <motion.p className='font-medium my-4' {...slideAnimation("left", 1.12)}> <b>User-Friendly Interface:</b> The app will have an intuitive and user-friendly interface, making it accessible to a wide range of users, including DIY enthusiasts, architects, engineers, and students. </motion.p>

                                <motion.h2 className='mb-4 text-2xl font-bold uppercase text-primary heading tracking-widest' {...slideAnimation("left", 0.9)}>Conclusion</motion.h2>
                                <motion.p className='font-medium my-4' {...slideAnimation("left", 1.12)}> The AR Measuring Tape project combines the power of Unity AR Foundation and basic ray tracing techniques to create an efficient and accurate tool for measuring distances in the real world. Whether for home improvement projects, interior design, or construction tasks, this application will empower users with the ability to make precise measurements using their mobile devices, making it an invaluable tool in various fields. </motion.p>
                            </div>
