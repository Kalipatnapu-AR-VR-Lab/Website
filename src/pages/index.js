...
export default function Home() {
  return (
    <>
      ...
      <TransitionEffect />
      <div className='w-full h-full bg-home bg-fixed bg-cover bg-left-top'>
        <main className='flex items-center text-dark w-full min-h-[95vh] dark:text-light py-24 glassmorphism'>
