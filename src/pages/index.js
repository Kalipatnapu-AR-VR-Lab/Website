...
export default function Home() {
  return (
    <>
      <Head>
        <title>KXR Portfolio</title>
        <meta name="description" content="Generated by create next app" />
      </Head>
      <TransitionEffect />

      <div className='w-screen h-screen -z-50 fixed overflow-hidden'>
        <Image src={home} className='object-cover h-full w-full object-top'/>
      </div>
          ...
          <Layout className='p-0 md:p-1.5 sm:p-8'>
            ...
            <div className='flex items-center justify-between w-full lg:flex-col'>
              <div className='w-1/2 md:w-full bg-transparent'>
                ...
                <motion.div className='w-[60%] flex flex-col items-center self-center xl:w-full lg:text-center heading glassmorphism p-8' {...slideAnimation("right",1.1)} >
                  ...
                  <motion.p className='my-4 text-xl font-medium md:!text-sm sm:!texr-xs' {...slideAnimation("right",1.1)} >We are a group of people who are insanely motivated to explore how we can engineer realities and experiences using tech.
                  </motion.p>

                  <motion.div className='flex item-center self-start mt-4 lg:self-center' {...HeadAnimation("right", 1.1)} >
