...
const Featured = ({ type, title, summary, img, link }) => {
  ...
  return (
    <motion.article className='w-full flex justify-between items-center border border-solid border-dark glassmorphism shadow-2xl p-12 relative lg:flex-col lg:p-8 xs:ronded-2xl xs:p-2 m-0' {...fadeAnimation}>
  ...
  return (
    <main className='flex w-full flex-col items-center justify-center'>
      <div className='pt-16'>
        ...
        <AnimatedText text="Education" className='mb-16 !text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8 ' />
        <motion.p className='text-2xl md:text-xl font-medium mb-16 text-center' {...slideAnimation("up", 0.5)}> Embark on an awe-inspiring voyage through the veil of reality with our team of tech sorcerers and art visionaries, where imagination and innovation converge to craft immersive worlds beyond imagination. 🚀🎨🌌 </motion.p>
