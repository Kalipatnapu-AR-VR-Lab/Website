...
const Batch = () => {
  return (
    <motion.div className='fixed left-4 bottom-4 flex items-center justify-center md:right-8 md:left-auto md:!top-0 md:bottom-auto sm:right-0 z-30' {...fadeAnimation} >
