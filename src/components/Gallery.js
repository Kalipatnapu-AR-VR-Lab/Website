...

          {
            gallery.map((photo) => {
              return (
                <div key={photo}>
                <Tilt>
                  <motion.div className='elative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-dark/30 glassmorphism' >
