 ...
 
          {
            gallery.map((photo, index) => {
              return (
                <div key={index}>
                <Tilt>
                  <motion.div className='elative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-dark/30 glassmorphism' {...slideAnimation("up", 0.2*index)} >
